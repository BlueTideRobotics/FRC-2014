...
void _GLOBAL__I__Z27potentiometerVoltCorrectionf();
...
void (*_ctors[])() =
    {
    _GLOBAL__I__Z27potentiometerVoltCorrectionf,
...
void _GLOBAL__D__Z27potentiometerVoltCorrectionf();
...
void (*_dtors[])() =
    {
    _GLOBAL__D__Z27potentiometerVoltCorrectionf,
